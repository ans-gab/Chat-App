...
const Question = (props) => {
  ...
  const requestmodel3 = () => {
    axios
      .post(
        props.funUrl + props.requestdata.preurl,
        {
        ...
        },
        {
          headers: {
            ...
            Authorization: 'Bearer ' + props.api
          }
        }
      )
      .then((res) => {
        ...
        if (props.requestdata.mode === 0) {
          ...
          props.setDialogList([
            ...store.getState().diologlist,
            { text, type: 'ingoing', isloading: false }
          ])
        } else {
          newDiologList.pop()
          props.setDialogList([
  ...
  const handleSetMessage = () => {
    if (props.requestdata.mode === 0) {
      ...
      props.message.shift()
      props.setMessage([
        { role: 'system', content: store.getState().system },
        ...props.message,
    ...
    <div className="chat-content">
      ...
      <div className="input-form">
        ...
        <Input
          ...
          disabled={btnmsg === '请求中'}
          style={{ width: 'calc(100% - 7rem)', background: '' }}
          value={inputValue}
          onChange={handleInputChange}
          onEnterPress={handleDialogInput}
          clearable
        />
        <Button
          disabled={btnmsg === '请求中'}
